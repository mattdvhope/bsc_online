...
ActiveRecord::Schema.define(version: 20180613120720) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "admin_applications", id: :serial, force: :cascade do |t|
    t.integer "user_id"
  ...
  create_table "cep_participations", force: :cascade do |t|
    t.integer "user_id"
  ...
  create_table "class_times", id: :serial, force: :cascade do |t|
    t.string "period"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "jekyll_users", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "off_site_locations", id: :serial, force: :cascade do |t|
  ...
  create_table "skype_time_slots", id: :serial, force: :cascade do |t|
    t.text "day"
    t.text "time_period"
    t.text "am_pm"
    t.datetime "created_at", null: false
