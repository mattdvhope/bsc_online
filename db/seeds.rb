...
jill    = User.create(first_name: 'Jill', last_name: 'Owens', nickname: "Jill", skype_name: "@Jill", line: "@Jill", role: "volunteer_administrator", phone_number: "099-555-4323", email: 'tim@test.tv', age: 27, gender: "Female", password: 'password', password_confirmation: 'password', postal_code: '10301', pin: "000000")
bop     = User.create(first_name: 'Bop', last_name: 'Satorn', nickname: "Bop", skype_name: "@Bop", line: "@Bop", off_site_location_id: 1, role: "student", phone_number: "099-555-4326", email: 'bop@test.tv', age: 30, gender: "ผู้ชาย", password: 'password', password_confirmation: 'password', postal_code: '10201', pin: "000000")
rain    = User.create(first_name: 'Rain', last_name: 'Silom', nickname: "Rain", skype_name: "@Rain", line: "@Rain", off_site_location_id: 2, role: "student", phone_number: "099-555-4327", email: 'rain@test.tv', age: 31, gender: "ผู้หญิง", password: 'password', password_confirmation: 'password', postal_code: '10101', pin: "000000")
matt    = User.create(first_name: 'Matt', last_name: 'Malone', nickname: "Matt", skype_name: "@Matt", line: "@Matt", role: "admin", phone_number: "099-555-4321", email: 'matt@test.tv', age: 25, gender: "Male", password: 'password', password_confirmation: 'password', postal_code: '10401', pin: "000000")
alex    = User.create(first_name: 'Alex', last_name: 'Blanton', nickname: "Alex", skype_name: "@Alex", line: "@Alex", role: "leader", phone_number: "099-555-4322", email: 'alex@test.tv', age: 26, gender: "Male", password: 'password', password_confirmation: 'password', postal_code: '10501', pin: "000000")
john    = User.create(first_name: 'John', last_name: 'Lapos', nickname: "John", skype_name: "@John", line: "@John", role: "volunteer", phone_number: "099-555-4324", email: 'john@test.tv', age: 28, gender: "Male", password: 'password', password_confirmation: 'password', postal_code: '10801', pin: "000000")
eric    = User.create(first_name: 'Eric', last_name: 'Mullis', nickname: "Eric", skype_name: "@Eric", line: "@Eric", role: "volunteer", phone_number: "099-555-4325", email: 'eric@test.tv', age: 29, gender: "Male", password: 'password', password_confirmation: 'password', postal_code: '10701', pin: "000000")
